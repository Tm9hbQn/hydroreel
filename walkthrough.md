...
6. **תיקון נראות (UI Hotfix)**: סודר באג רספונסיביות בו טקסט ארוך של שאלות הסתתר מאחורי הכותרות הדביקות. כעת אזור השאלה נגלל פנימית (Scroll) מבלי לפגוע במבנה הכללי או לדחוף את השאלה אל מחוץ למסך.
