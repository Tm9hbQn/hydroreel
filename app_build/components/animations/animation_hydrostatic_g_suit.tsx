...
export default function HydrostaticGSuitAnimation() {
  return (
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-0 overflow-hidden w-full">
        <div className="relative h-full w-full max-h-[400px] max-w-[280px]">
          ...
          <motion.div
            ...
            style={{ top: '65%', right: '0%', transform: 'translate(0, -50%)' }}
            dir="ltr"
          >
            <div className="w-12 sm:w-20 h-[2px] bg-blue-600" />
            <div className="bg-blue-600 text-white text-xs font-bold px-2 py-1 rounded shadow-md whitespace-normal text-center max-w-[100px] ml-1" dir="rtl">
              לחץ המים דוחף דם בחזרה ללב
            </div>
          </motion.div>
        </div>
      </div>
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              הלחץ ההידרוסטטי מתפקד כ"חליפת לחץ" אידיאלית, מונע את הצטברות הדם, ומאפשר אימון בעמידה (Vertical) ללא עילפון
            </p>
          </div>
        </motion.div>
      </div>
