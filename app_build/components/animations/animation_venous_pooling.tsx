...
export default function VenousPoolingAnimation() {
  return (
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-0 overflow-hidden w-full">
        <div className="relative h-full w-full max-h-[400px] max-w-[280px]">
          ...
          <motion.div
            ...
            style={{ top: '80%', left: '0%', transform: 'translate(0, -50%)' }}
            dir="ltr"
          >
            <div className="bg-red-500 text-white text-xs font-bold px-2 py-1 rounded shadow-md whitespace-normal text-center max-w-[100px] mr-1" dir="rtl">
              הצטברות דם ברגליים
            </div>
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              ביבשה, הדם נוטה להצטבר בגפיים התחתונות, מה שגורם לירידת לחץ דם, דופק מהיר ועילפון בעמידה
            </p>
          </div>
        </motion.div>
      </div>
