...
import SpineSagittal from "../visuals/SpineSagittal";

export default function SpondylolisthesisCoreAnimation() {
  return (
      ...
      <div className="flex-none pt-8 pb-4 px-4 w-full flex justify-center z-20 pointer-events-none">
        ...
        >
          <span className="text-sm font-semibold text-slate-800 dark:text-slate-200">
            Spondylolisthesis (ספונדילוליסטזיס) - ייצוב שרירי ליבה
          </span>
        </motion.div>
      </div>
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              התנגדות המים מחזקת את המייצבים ומפחיתה גלישה (Slip)
            </p>
          </div>
        </motion.div>
      </div>
