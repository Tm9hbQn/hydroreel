...
export default function PulmonaryEdemaAnimation() {
  return (
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-0 overflow-hidden w-full">
        <div className="relative h-full w-full max-h-[350px] max-w-[280px]">
          ...
          <motion.div
            ...
            style={{ top: '70%', left: '0%', transform: 'translate(10px, -50%)' }}
            dir="ltr"
          >
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              כאשר הלב אינו מצליח לשאוב את ה-700 מ"ל הנוספים, הדם "חוזר אחורה" ומציף את הריאות בנוזלים
            </p>
          </div>
        </motion.div>
      </div>
