...
import BloodVesselVasoSvg from "../visuals/BloodVesselVasoSvg";

export default function VasodilationInsulinAnimation() {
  return (
      ...
      <div className="flex-none pt-8 pb-4 px-4 w-full flex justify-center z-20 pointer-events-none">
        ...
        >
          <span className="text-sm font-semibold text-slate-800 dark:text-slate-200">
            מים חמים ואינסולין (Vasodilation)
          </span>
        </motion.div>
      </div>
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-0 overflow-hidden w-full">
        <div className="relative h-full w-full max-h-[350px] max-w-[280px]">
          ...
          <motion.div
            ...
            style={{ top: '80%', left: '0%', transform: 'translate(10px, -50%)' }}
            dir="ltr"
          >
            <div className="bg-orange-500 text-white text-xs font-bold px-2 py-1 rounded shadow-md whitespace-normal text-center max-w-[100px] mr-1" dir="rtl">
              הרחבת כלי דם בגלל חום המים
            </div>
            <div className="w-12 sm:w-20 h-[2px] bg-orange-500" />
          </motion.div>
        </div>
      </div>
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              כלי הדם המורחבים קולטים אינסולין וגלוקוז במהירות גבוהה הרבה יותר מאשר ביבשה
            </p>
          </div>
        </motion.div>
      </div>
