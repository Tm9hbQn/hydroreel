...
export default function PotsAerobicVerticalAnimation() {
  return (
      ...
      <div className="flex-none pt-8 pb-4 px-4 w-full flex justify-center z-20 pointer-events-none">
        ...
        >
          <span className="text-sm font-semibold text-slate-800 dark:text-slate-200">
            POTS - אימון אירובי אנכי במים (Vertical)
          </span>
        </motion.div>
      </div>
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-0 overflow-hidden w-full">
        <div className="relative h-full w-full max-h-[350px] max-w-[220px]">
          ...
          <motion.div
            ...
            dir="ltr"
          >
            <div className="bg-emerald-600 text-white text-xs font-bold px-2 py-1 rounded shadow-md whitespace-normal text-center max-w-[100px] mr-1" dir="rtl">
              ריצה במים (Water Running)
            </div>
            <div className="w-12 sm:w-20 h-[2px] bg-emerald-600" />
          </motion.div>
        </div>
      </div>
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              בזכות תמיכת המים, ניתן להתאמן בעצימות גבוהה במנח זקוף ולשקם את מערכת העצבים האוטונומית
            </p>
          </div>
        </motion.div>
      </div>
