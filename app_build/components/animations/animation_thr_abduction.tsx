...
export default function ThrAbductionAnimation() {
  return (
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-0 overflow-hidden w-full">
        <div className="relative h-full w-full max-h-[400px] max-w-[280px]">
          ...
          <motion.div
            ...
            dir="ltr"
          >
            <div className="bg-emerald-500 text-white text-xs font-bold px-2 py-1 rounded shadow-md whitespace-normal text-center max-w-[120px] mr-1" dir="rtl">
              Abduction מבוקר (Safe)
            </div>
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              כוח העילוי מאפשר הרחקת ירך בטוחה ללא עומס משקל מלא
            </p>
          </div>
        </motion.div>
      </div>
