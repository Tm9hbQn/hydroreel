...
export default function HydrostaticCorsetAnimation() {
  return (
        ...
        <div className="relative h-full w-full max-h-[350px] max-w-[280px]">
          ...
          >
            <div className="bg-blue-600 text-white text-xs font-bold px-2 py-1 rounded shadow-md whitespace-normal text-center max-w-[100px] mr-1" dir="rtl">
              לחץ הידרוסטטי "מועך" את בית החזה
            </div>
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              המים מפעילים התנגדות כנגד התרחבות בית החזה ומקשים על השאיפה (Inspiration)
            </p>
          </div>
        </motion.div>
      </div>
