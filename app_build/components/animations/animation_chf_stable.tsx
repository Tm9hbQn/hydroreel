...
export default function ChfStableAnimation() {
  return (
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-0 overflow-hidden w-full">
        <div className="relative h-full w-full max-h-[350px] max-w-[280px]">
          ...
          <motion.div
            ...
            style={{ top: '60%', right: '0%', transform: 'translate(0, -50%)' }}
            dir="ltr"
          >
            <div className="w-12 sm:w-20 h-[2px] bg-emerald-500" />
            <div className="bg-emerald-500 text-white text-xs font-bold px-2 py-1 rounded shadow-md whitespace-normal text-center max-w-[100px] ml-1" dir="rtl">
              הסתגלות הדרגתית ועומס מתון
            </div>
          </motion.div>
        </div>
      </div>
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              כניסה למים עד גובה המותניים בלבד (מפחית Blood Shift)
            </p>
          </div>
        </motion.div>
      </div>
