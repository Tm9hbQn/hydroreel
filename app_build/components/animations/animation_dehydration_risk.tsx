...
export default function DehydrationRiskAnimation() {
  return (
        ...
        <div className="relative h-full w-full max-h-[350px] max-w-[280px]">
          ...
          >
            ...
            <div className="bg-red-500 text-white text-xs font-bold px-2 py-1 rounded shadow-md whitespace-normal text-center max-w-[100px] ml-1" dir="rtl">
              אובדן נוזלים מסיבי ללא תחושת צמא
            </div>
          </motion.div>
        </div>
      </div>
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              בגלל שהדם במרכז, המוח לא מזהה חוסר בנוזלים ולא מפעיל צמא. חובה לשתות לפני ואחרי!
            </p>
          </div>
        </motion.div>
      </div>
