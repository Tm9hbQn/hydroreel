...
export default function LungComplianceAnimation() {
  return (
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-0 overflow-hidden w-full">
        <div className="relative h-full w-full max-h-[350px] max-w-[280px]">
          ...
          <motion.div
            ...
            dir="ltr"
          >
            <div className="w-12 sm:w-20 h-[2px] bg-indigo-500" />
            <div className="bg-indigo-500 text-white text-xs font-bold px-2 py-1 rounded shadow-md whitespace-normal text-center max-w-[100px] ml-1" dir="rtl">
              היענות הריאה יורדת (נוקשה יותר)
            </div>
          </motion.div>
        </div>
      </div>
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              הדם המרכזי שגודש את הריאות יחד עם לחץ המים הופכים את הריאה לנוקשה, ועבודת הנשימה (Work of Breathing) עולה ב-60%
            </p>
          </div>
        </motion.div>
      </div>
