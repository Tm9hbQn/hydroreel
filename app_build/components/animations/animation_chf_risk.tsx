...
export default function ChfRiskAnimation() {
  return (
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-0 overflow-hidden w-full">
        <div className="relative h-full w-full max-h-[350px] max-w-[280px]">
          ...
          <motion.div
            ...
            style={{ top: '60%', left: '0%', transform: 'translate(10px, -50%)' }}
            dir="ltr"
          >
            <div className="bg-red-600 text-white text-xs font-bold px-2 py-1 rounded shadow-md whitespace-normal text-center max-w-[100px] mr-1" dir="rtl">
              עומס יתר על שריר חלש
            </div>
        ...
        >
          <div>
            <p className="text-xs text-red-600 dark:text-red-400 font-bold uppercase tracking-wider mb-1">
              התווית נגד במים עמוקים
            </p>
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              התוספת של 700 מ"ל דם עלולה להכריע לב כושל ולהוביל לבצקת ריאות
            </p>
          </div>
        </motion.div>
      </div>
