...
import JointSvg from "../visuals/JointSvg";

export default function PerthesContainmentAnimation() {
  return (
      ...
      <div className="flex-none pt-8 pb-4 px-4 w-full flex justify-center z-20 pointer-events-none">
        ...
        >
          <span className="text-sm font-semibold text-slate-800 dark:text-slate-200">
            Perthes Disease - הכלה (Containment)
          </span>
        </motion.div>
      </div>
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-0 overflow-hidden w-full">
        <div className="relative h-full w-full max-h-[400px] max-w-[280px]">
          ...
          <motion.div
            ...
            style={{ top: '30%', right: '10%', transform: 'translate(0, -50%)' }}
            dir="ltr"
          >
            <div className="w-12 sm:w-24 h-[2px] bg-emerald-500" />
            <div className="bg-emerald-500 text-white text-xs font-bold px-2 py-1 rounded shadow-md whitespace-normal text-center max-w-[120px] ml-1" dir="rtl">
              הכלת ראש הירך ע"י Abduction
            </div>
          </motion.div>
        </div>
      </div>
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              המים מאפשרים תנועה בטווח "ההכלה" במפרק, שומרים על תקינות צורתו
            </p>
          </div>
        </motion.div>
      </div>
