...
export default function AnpReleaseAnimation() {
  return (
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-0 overflow-hidden w-full">
        <div className="relative h-full w-full max-h-[350px] max-w-[280px]">
          ...
          <motion.div
            ...
            dir="ltr"
          >
            <div className="bg-amber-500 text-white text-xs font-bold px-2 py-1 rounded shadow-md whitespace-normal text-center max-w-[100px] mr-1" dir="rtl">
              מולקולות ANP טסות לכליות
            </div>
        ...
        >
          <div>
            <p className="text-xs text-slate-500 dark:text-slate-400 font-medium uppercase tracking-wider mb-1">
              המנגנון (Atrial Natriuretic Peptide)
            </p>
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              העליות בלב נמתחות מדם עודף ומשחררות ANP שמעודד הפרשת נתרן ושתן
            </p>
          </div>
        </motion.div>
      </div>
