...
import SpineCoronal from "../visuals/SpineCoronal";

export default function ScoliosisDerotationAnimation() {
  return (
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              התנגדות זורמים יוצרת מומנט רוטציוני מתקן סביב ציר עמוד השדרה
            </p>
          </div>
        </motion.div>
      </div>
