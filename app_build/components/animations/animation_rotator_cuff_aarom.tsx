...
export default function RotatorCuffAaromAnimation() {
  return (
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-0 overflow-hidden w-full">
        <div className="relative h-full w-full max-h-[400px] max-w-[280px]">
          ...
          <motion.div
            ...
            style={{ bottom: '20%', right: '10%', transform: 'translate(0, 50%)' }}
            dir="ltr"
          >
            <div className="w-12 sm:w-24 h-[2px] bg-blue-500" />
            <div className="bg-blue-500 text-white text-xs font-bold px-2 py-1 rounded shadow-md whitespace-normal text-center max-w-[120px] ml-1" dir="rtl">
              כוח עילוי מסייע בתנועה (AAROM)
            </div>
          </motion.div>
        </div>
      </div>
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              המצוף והמים מרימים את היד באופן פסיבי ומונעים עומס מהשריר הקרוע
            </p>
          </div>
        </motion.div>
      </div>
