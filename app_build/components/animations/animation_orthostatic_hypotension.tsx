...
import VenousReturnSvg from "../visuals/VenousReturnSvg";

export default function OrthostaticHypotensionAnimation() {
  return (
      ...
      <div className="flex-none pt-8 pb-4 px-4 w-full flex justify-center z-20 pointer-events-none">
        ...
        >
          <span className="text-sm font-semibold text-slate-800 dark:text-slate-200">
            Orthostatic Hypotension (סכנת עילפון)
          </span>
        </motion.div>
      </div>
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-0 overflow-hidden w-full">
        <div className="relative h-full w-full max-h-[400px] max-w-[280px]">
          ...
          <motion.div
            ...
            style={{ top: '80%', right: '0%', transform: 'translate(0, -50%)' }}
            dir="ltr"
          >
            <div className="w-12 sm:w-20 h-[2px] bg-red-600" />
            <div className="bg-red-600 text-white text-xs font-bold px-2 py-1 rounded shadow-md whitespace-normal text-center max-w-[100px] ml-1" dir="rtl">
              הדם "נופל" חזרה לרגליים ביציאה מהמים
            </div>
          </motion.div>
        </div>
      </div>
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              הגוף איבד נוזלים בשתן וכעת מאבד את תמיכת המים. חובה לצאת לאט כדי למנוע ירידת לחץ דם חדה ועילפון
            </p>
          </div>
        </motion.div>
      </div>
