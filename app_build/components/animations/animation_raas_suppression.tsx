...
export default function RaasSuppressionAnimation() {
  return (
        ...
        >
          <div>
            ...
            <p className="text-sm font-bold text-slate-800 dark:text-slate-100">
              כדי להילחם ב"עודף הדם" במרכז, הכליות משביתות את מנגנון ה-RAAS שתפקידו לשמר נוזלים
            </p>
          </div>
        </motion.div>
      </div>
